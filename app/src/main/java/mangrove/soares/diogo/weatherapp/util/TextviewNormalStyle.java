...
public class TextviewNormalStyle extends android.support.v7.widget.AppCompatTextView {

    public TextviewNormalStyle(Context context) {
        this(context, null);
    }

    public TextviewNormalStyle(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TextviewNormalStyle(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        Typeface face=Typeface.createFromAsset(context.getAssets(), "Comfortaa-Light.ttf");
